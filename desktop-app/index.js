...
var lastSentSidestickPacketTimestamp = 0;
...
function handle_hid(data) {
    ...
    if(lastSentSidestickPacketTimestamp == 0) {
        lastSentSidestickPacketTimestamp = Date.now();
    }

    if(Date.now() - lastSentSidestickPacketTimestamp < 1000) {
        return;
    } else lastSentSidestickPacketTimestamp = Date.now();
